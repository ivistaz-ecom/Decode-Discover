...
export function countUp(element, endValue, options) {
...
export function attachHoverLift(element) {
    const onEnter = () => gsap.to(element, { y: -2, scale: 1.02, duration: 0.25, ease: EASE_OUT });
    const onLeave = () => gsap.to(element, { y: 0, scale: 1, duration: 0.3, ease: EASE_OUT });
