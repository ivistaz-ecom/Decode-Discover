...
export function LoginForm() {
    ...
    if (!isFirebaseConfigured()) {
        return (<div className="rounded-lg border border-amber-700/40 bg-amber-950/40 p-4 text-sm text-amber-100">
    ...
    return (<div className="relative w-full max-w-md">
      <div className="relative overflow-hidden rounded-xl border border-[#4a4238] bg-[#2a2621] shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
        ...
        <div className="px-6 py-7 sm:px-8">
          ...
          {serverStatus === "firebase-auth-off" && (<div className="mb-5 rounded-lg border border-amber-700/40 bg-amber-950/30 px-4 py-3 text-sm text-amber-100">
              ...
              <ol className="mt-2 list-decimal space-y-1 pl-4 text-amber-200/90">
                <li>
                  Open{" "}
                  <a href={FIREBASE_AUTH_SETUP_URL} target="_blank" rel="noopener noreferrer" className="cursor-pointer underline">
          ...
          {serverStatus === "server-env-missing" && (<div className="mb-5 rounded-lg border border-amber-700/40 bg-amber-950/30 px-4 py-3 text-sm text-amber-100">
          ...
          {error && (<div className="mb-5 rounded-lg border border-red-800/50 bg-red-950/30 px-4 py-3 text-sm text-red-200">
              <p>{error}</p>
              {error === AUTH_NOT_CONFIGURED_MESSAGE && (<a href={FIREBASE_AUTH_SETUP_URL} target="_blank" rel="noopener noreferrer" className="mt-2 inline-block cursor-pointer underline">
